...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        if who == 0:
            ...
            if feral_hogs and abs(last_score1 - strat0) == 2:
                score0 += 3
            last_score0 = take_turn(strat0, score1, dice)
            # print(last_score0)
            score0 += last_score0
            ...
            if feral_hogs and abs(last_score1 - strat1) == 2:
                score1 += 3
            last_score1 = take_turn(strat1, score0, dice)
            score1 += last_score1
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if score - last_score > _running_high:
            _running_high = score - last_score
            print(_running_high, 'point(s)! That\'s the biggest gain yet for Player', who)
        return announce_highest(who, score, _running_high)
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    bacon = 10 - opponent_score % 10 + opponent_score % 100 // 10
    if bacon >= cutoff:
        return 0
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if score < 30 and opponent_score < 40:
